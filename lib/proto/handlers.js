...
export const beginAuthSessionViaCredentials = {
  ...
  method: 'POST',
  req: (accountName, encryptedPassword, encryptionTimestamp, userAgent) =>
    encodeB64(P.BeginAuthSessionViaCredentialsReq, {
      accountName, encryptedPassword, encryptionTimestamp, deviceFriendlyName: userAgent,
      rememberLogin: true, persistence: 1, websiteId: 'Community', platformType: 2
    }),
...
export const updateAuthSessionWithSteamGuardCode = {
  ...
  method: 'POST',
  req: (clientId, steamid, code, codeType = 3) =>
