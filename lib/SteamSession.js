...
export default class SteamSession {
  ...
  static async Auto(login, password, actor, sessiontype = 'web', logurl, logcookies) {
    ...
    await session.useSessionSaveLocation(os.homedir(), '.cache', 'steam-session', login, sessiontype)
