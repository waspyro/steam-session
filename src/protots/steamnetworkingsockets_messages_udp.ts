...
export function cMsgSteamSocketsUDPStats_FlagsFromJSON(object: any): CMsgSteamSocketsUDPStats_Flags {
  switch (object) {
    ...
    case "UNRECOGNIZED":
    default:
      return CMsgSteamSocketsUDPStats_Flags.UNRECOGNIZED;
  }
}
...
export function cMsgSteamSocketsUDPStats_FlagsToJSON(object: CMsgSteamSocketsUDPStats_Flags): string {
  switch (object) {
    ...
    case CMsgSteamSocketsUDPStats_Flags.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const CMsgSteamSocketsUDPChallengeRequest = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPChallengeRequest>, I>>(
    base?: I,
  ): CMsgSteamSocketsUDPChallengeRequest {
    return CMsgSteamSocketsUDPChallengeRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPChallengeRequest>, I>>(
    object: I,
  ): CMsgSteamSocketsUDPChallengeRequest {
    const message = createBaseCMsgSteamSocketsUDPChallengeRequest();
...
export const CMsgSteamSocketsUDPChallengeReply = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPChallengeReply>, I>>(
    base?: I,
  ): CMsgSteamSocketsUDPChallengeReply {
    return CMsgSteamSocketsUDPChallengeReply.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPChallengeReply>, I>>(
    object: I,
  ): CMsgSteamSocketsUDPChallengeReply {
    const message = createBaseCMsgSteamSocketsUDPChallengeReply();
    message.connectionId = object.connectionId ?? 0;
...
export const CMsgSteamSocketsUDPConnectRequest = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPConnectRequest>, I>>(
    base?: I,
  ): CMsgSteamSocketsUDPConnectRequest {
    return CMsgSteamSocketsUDPConnectRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPConnectRequest>, I>>(
    object: I,
  ): CMsgSteamSocketsUDPConnectRequest {
    const message = createBaseCMsgSteamSocketsUDPConnectRequest();
...
export const CMsgSteamSocketsUDPConnectOK = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPConnectOK>, I>>(base?: I): CMsgSteamSocketsUDPConnectOK {
    return CMsgSteamSocketsUDPConnectOK.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPConnectOK>, I>>(object: I): CMsgSteamSocketsUDPConnectOK {
    const message = createBaseCMsgSteamSocketsUDPConnectOK();
    message.clientConnectionId = object.clientConnectionId ?? 0;
...
export const CMsgSteamSocketsUDPConnectionClosed = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPConnectionClosed>, I>>(
    base?: I,
  ): CMsgSteamSocketsUDPConnectionClosed {
    return CMsgSteamSocketsUDPConnectionClosed.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPConnectionClosed>, I>>(
    object: I,
  ): CMsgSteamSocketsUDPConnectionClosed {
    const message = createBaseCMsgSteamSocketsUDPConnectionClosed();
...
export const CMsgSteamSocketsUDPNoConnection = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPNoConnection>, I>>(base?: I): CMsgSteamSocketsUDPNoConnection {
    return CMsgSteamSocketsUDPNoConnection.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPNoConnection>, I>>(
    object: I,
...
export const CMsgSteamSocketsUDPStats = {
  ...
  create<I extends Exact<DeepPartial<CMsgSteamSocketsUDPStats>, I>>(base?: I): CMsgSteamSocketsUDPStats {
    return CMsgSteamSocketsUDPStats.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgSteamSocketsUDPStats>, I>>(object: I): CMsgSteamSocketsUDPStats {
    const message = createBaseCMsgSteamSocketsUDPStats();
