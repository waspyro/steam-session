...
export const CMsgClientHeartBeat = {
  encode(message: CMsgClientHeartBeat, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sendReply === true) {
  ...
  fromJSON(object: any): CMsgClientHeartBeat {
    return { sendReply: isSet(object.sendReply) ? Boolean(object.sendReply) : false };
  },

  toJSON(message: CMsgClientHeartBeat): unknown {
    const obj: any = {};
    message.sendReply !== undefined && (obj.sendReply = message.sendReply);
    return obj;
  },

  create<I extends Exact<DeepPartial<CMsgClientHeartBeat>, I>>(base?: I): CMsgClientHeartBeat {
    return CMsgClientHeartBeat.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientHeartBeat>, I>>(object: I): CMsgClientHeartBeat {
    const message = createBaseCMsgClientHeartBeat();
    message.sendReply = object.sendReply ?? false;
    return message;
  },
};
...
export const CMsgClientServerTimestampRequest = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientServerTimestampRequest>, I>>(
    base?: I,
  ): CMsgClientServerTimestampRequest {
    return CMsgClientServerTimestampRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientServerTimestampRequest>, I>>(
    object: I,
  ): CMsgClientServerTimestampRequest {
    const message = createBaseCMsgClientServerTimestampRequest();
...
export const CMsgClientServerTimestampResponse = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientServerTimestampResponse>, I>>(
    base?: I,
  ): CMsgClientServerTimestampResponse {
    return CMsgClientServerTimestampResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientServerTimestampResponse>, I>>(
    object: I,
  ): CMsgClientServerTimestampResponse {
    const message = createBaseCMsgClientServerTimestampResponse();
    message.clientRequestTimestamp = object.clientRequestTimestamp ?? "0";
...
export const CMsgClientSecret = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientSecret>, I>>(base?: I): CMsgClientSecret {
    return CMsgClientSecret.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientSecret>, I>>(object: I): CMsgClientSecret {
    const message = createBaseCMsgClientSecret();
...
export const CMsgClientHello = {
  ...
  fromJSON(object: any): CMsgClientHello {
    return { protocolVersion: isSet(object.protocolVersion) ? Number(object.protocolVersion) : 0 };
  },
...
export const CMsgClientLogon = {
  encode(message: CMsgClientLogon, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.disablePartnerAutogrants === true) {
      writer.uint32(848).bool(message.disablePartnerAutogrants);
    }
    if (message.isSteamDeck === true) {
      writer.uint32(856).bool(message.isSteamDeck);
    }
    if (message.accessToken !== "") {
      writer.uint32(866).string(message.accessToken);
    }
    if (message.isChromeOs === true) {
      writer.uint32(872).bool(message.isChromeOs);
    }
    if (message.isTesla === true) {
      writer.uint32(880).bool(message.isTesla);
    }
    return writer;
  },
  ...
  fromJSON(object: any): CMsgClientLogon {
    return {
      ...
      embeddedClientSecret: isSet(object.embeddedClientSecret)
        ...
        : undefined,
      disablePartnerAutogrants: isSet(object.disablePartnerAutogrants)
        ? Boolean(object.disablePartnerAutogrants)
        : false,
      isSteamDeck: isSet(object.isSteamDeck) ? Boolean(object.isSteamDeck) : false,
      accessToken: isSet(object.accessToken) ? String(object.accessToken) : "",
      isChromeOs: isSet(object.isChromeOs) ? Boolean(object.isChromeOs) : false,
      isTesla: isSet(object.isTesla) ? Boolean(object.isTesla) : false,
    };
  },
  ...
  toJSON(message: CMsgClientLogon): unknown {
    ...
    message.embeddedClientSecret !== undefined && (obj.embeddedClientSecret = message.embeddedClientSecret
      ...
      : undefined);
    message.disablePartnerAutogrants !== undefined && (obj.disablePartnerAutogrants = message.disablePartnerAutogrants);
    message.isSteamDeck !== undefined && (obj.isSteamDeck = message.isSteamDeck);
    message.accessToken !== undefined && (obj.accessToken = message.accessToken);
    message.isChromeOs !== undefined && (obj.isChromeOs = message.isChromeOs);
    message.isTesla !== undefined && (obj.isTesla = message.isTesla);
    return obj;
  },

  create<I extends Exact<DeepPartial<CMsgClientLogon>, I>>(base?: I): CMsgClientLogon {
    return CMsgClientLogon.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientLogon>, I>>(object: I): CMsgClientLogon {
    const message = createBaseCMsgClientLogon();
    message.protocolVersion = object.protocolVersion ?? 0;
    ...
    message.embeddedClientSecret = (object.embeddedClientSecret !== undefined && object.embeddedClientSecret !== null)
      ...
      : undefined;
    message.disablePartnerAutogrants = object.disablePartnerAutogrants ?? false;
    message.isSteamDeck = object.isSteamDeck ?? false;
    message.accessToken = object.accessToken ?? "";
    message.isChromeOs = object.isChromeOs ?? false;
    message.isTesla = object.isTesla ?? false;
    return message;
  },
};
...
export const CMsgClientLogonResponse = {
  encode(message: CMsgClientLogonResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.legacyOutOfGameHeartbeatSeconds !== 0) {
    ...
    if (message.deprecatedUsePics === true) {
  ...
  fromJSON(object: any): CMsgClientLogonResponse {
    return {
      ...
      legacyOutOfGameHeartbeatSeconds: isSet(object.legacyOutOfGameHeartbeatSeconds)
        ? Number(object.legacyOutOfGameHeartbeatSeconds)
        : 0,
      heartbeatSeconds: isSet(object.heartbeatSeconds) ? Number(object.heartbeatSeconds) : 0,
      deprecatedPublicIp: isSet(object.deprecatedPublicIp) ? Number(object.deprecatedPublicIp) : 0,
      ...
      publicIp: isSet(object.publicIp) ? CMsgIPAddress.fromJSON(object.publicIp) : undefined,
      userCountry: isSet(object.userCountry) ? String(object.userCountry) : "",
      clientSuppliedSteamid: isSet(object.clientSuppliedSteamid) ? String(object.clientSuppliedSteamid) : "0",
  ...
  toJSON(message: CMsgClientLogonResponse): unknown {
    ...
    message.legacyOutOfGameHeartbeatSeconds !== undefined &&
      (obj.legacyOutOfGameHeartbeatSeconds = Math.round(message.legacyOutOfGameHeartbeatSeconds));
    message.heartbeatSeconds !== undefined && (obj.heartbeatSeconds = Math.round(message.heartbeatSeconds));
    message.deprecatedPublicIp !== undefined && (obj.deprecatedPublicIp = Math.round(message.deprecatedPublicIp));
    ...
    message.deprecatedUsePics !== undefined && (obj.deprecatedUsePics = message.deprecatedUsePics);
    message.vanityUrl !== undefined && (obj.vanityUrl = message.vanityUrl);
    message.publicIp !== undefined &&
      (obj.publicIp = message.publicIp ? CMsgIPAddress.toJSON(message.publicIp) : undefined);
    message.userCountry !== undefined && (obj.userCountry = message.userCountry);
    message.clientSuppliedSteamid !== undefined && (obj.clientSuppliedSteamid = message.clientSuppliedSteamid);
  ...
  create<I extends Exact<DeepPartial<CMsgClientLogonResponse>, I>>(base?: I): CMsgClientLogonResponse {
    return CMsgClientLogonResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientLogonResponse>, I>>(object: I): CMsgClientLogonResponse {
    const message = createBaseCMsgClientLogonResponse();
    message.eresult = object.eresult ?? 0;
    message.legacyOutOfGameHeartbeatSeconds = object.legacyOutOfGameHeartbeatSeconds ?? 0;
    ...
    message.deprecatedUsePics = object.deprecatedUsePics ?? false;
    message.vanityUrl = object.vanityUrl ?? "";
    message.publicIp = (object.publicIp !== undefined && object.publicIp !== null)
      ? CMsgIPAddress.fromPartial(object.publicIp)
      : undefined;
    message.userCountry = object.userCountry ?? "";
    message.clientSuppliedSteamid = object.clientSuppliedSteamid ?? "0";
...
export const CMsgClientRequestWebAPIAuthenticateUserNonce = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientRequestWebAPIAuthenticateUserNonce>, I>>(
    base?: I,
  ): CMsgClientRequestWebAPIAuthenticateUserNonce {
    return CMsgClientRequestWebAPIAuthenticateUserNonce.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientRequestWebAPIAuthenticateUserNonce>, I>>(
    object: I,
  ): CMsgClientRequestWebAPIAuthenticateUserNonce {
    const message = createBaseCMsgClientRequestWebAPIAuthenticateUserNonce();
...
export const CMsgClientRequestWebAPIAuthenticateUserNonceResponse = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientRequestWebAPIAuthenticateUserNonceResponse>, I>>(
    base?: I,
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgClientRequestWebAPIAuthenticateUserNonceResponse>, I>>(
    object: I,
  ): CMsgClientRequestWebAPIAuthenticateUserNonceResponse {
    const message = createBaseCMsgClientRequestWebAPIAuthenticateUserNonceResponse();
    message.eresult = object.eresult ?? 0;
...
export const CMsgClientLogOff = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientLogOff>, I>>(base?: I): CMsgClientLogOff {
    return CMsgClientLogOff.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientLogOff>, I>>(_: I): CMsgClientLogOff {
    const message = createBaseCMsgClientLogOff();
    return message;
  },
};
...
export const CMsgClientLoggedOff = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientLoggedOff>, I>>(base?: I): CMsgClientLoggedOff {
    return CMsgClientLoggedOff.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientLoggedOff>, I>>(object: I): CMsgClientLoggedOff {
    const message = createBaseCMsgClientLoggedOff();
    message.eresult = object.eresult ?? 0;
    return message;
  },
...
export const CMsgClientNewLoginKey = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientNewLoginKey>, I>>(base?: I): CMsgClientNewLoginKey {
    return CMsgClientNewLoginKey.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientNewLoginKey>, I>>(object: I): CMsgClientNewLoginKey {
    const message = createBaseCMsgClientNewLoginKey();
...
export const CMsgClientNewLoginKeyAccepted = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientNewLoginKeyAccepted>, I>>(base?: I): CMsgClientNewLoginKeyAccepted {
    return CMsgClientNewLoginKeyAccepted.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientNewLoginKeyAccepted>, I>>(
    object: I,
...
export const CMsgClientAccountInfo = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientAccountInfo>, I>>(base?: I): CMsgClientAccountInfo {
    return CMsgClientAccountInfo.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CMsgClientAccountInfo>, I>>(object: I): CMsgClientAccountInfo {
    const message = createBaseCMsgClientAccountInfo();
...
export const CMsgClientChallengeRequest = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientChallengeRequest>, I>>(base?: I): CMsgClientChallengeRequest {
...
export const CMsgClientChallengeResponse = {
  ...
  create<I extends Exact<DeepPartial<CMsgClientChallengeResponse>, I>>(base?: I): CMsgClientChallengeResponse {
